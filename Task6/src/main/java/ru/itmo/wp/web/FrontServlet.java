...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method method = getMethodBySignature(route.getAction(), pageClass, HttpServletRequest.class, Map.class);
        ...
        try {
            Method beforeAction = getMethodBySignature("before", pageClass, HttpServletRequest.class, Map.class);
            invokeNullable(beforeAction, page, request, view);

            invokeNullable(method, page, request, view);

            Method afterAction = getMethodBySignature("after", pageClass, HttpServletRequest.class, Map.class);
            invokeNullable(afterAction, page, request, view);
    ...
    private Method getMethodBySignature(String name, Class<?> pageClass, Class<?>... parameterTypes) {
        Method method = null;
    ...
    private void invokeNullable(Method method, Object instance, Object... args) throws InvocationTargetException, IllegalAccessException {
        if (method != null) {
